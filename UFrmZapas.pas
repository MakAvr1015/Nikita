...
type
  TFrmZapas = class(TFrmPrototype)
    ...
    dsGoodScancodesF_GOOD: TFIBBCDField;
    dsGoodScancodesF_SCANCODE: TFIBBCDField;
    dsGoodScancodesF_SKLAD: TFIBBCDField;
    dsGoodScancodesF_DATE: TFIBDateField;
    dsGoodScancodesF_STR_OST: TFIBFloatField;
    dsGoodScancodesF_MOVE_IN: TFIBFloatField;
    dsGoodScancodesF_WAIT_IN: TFIBFloatField;
    dsGoodScancodesF_MOVE_OUT: TFIBFloatField;
    dsGoodScancodesF_WAIT_OUT: TFIBFloatField;
    dsGoodScancodesF_END_OST: TFIBFloatField;
    dsGoodScancodesF_GOOD_GRP: TFIBBCDField;
    dsGoodScancodesF_GOOD_NAME: TFIBStringField;
    dsGoodScancodesF_GOOD_ARTICLE: TFIBStringField;
    dsGoodScancodesF_GOOD_GRP_NAME: TFIBStringField;
    dsGoodScancodesF_GOOD_GRP_COLOR: TFIBStringField;
    dsGoodScancodesF_PRICE_VAL: TFIBBCDField;
    dsGoodScancodesF_GOOD_DOP_INFO: TFIBStringField;
    dsGoodScancodesF_PHOTO_EXISTS: TFIBSmallIntField;
    cxGrid2DBTableView2F_ID: TcxGridDBColumn;
    cxGrid2DBTableView2F_GOOD: TcxGridDBColumn;
    cxGrid2DBTableView2F_SCANCODE: TcxGridDBColumn;
    cxGrid2DBTableView2F_SKLAD: TcxGridDBColumn;
    cxGrid2DBTableView2F_DATE: TcxGridDBColumn;
    cxGrid2DBTableView2F_STR_OST: TcxGridDBColumn;
    cxGrid2DBTableView2F_MOVE_IN: TcxGridDBColumn;
    cxGrid2DBTableView2F_WAIT_IN: TcxGridDBColumn;
    cxGrid2DBTableView2F_MOVE_OUT: TcxGridDBColumn;
    cxGrid2DBTableView2F_WAIT_OUT: TcxGridDBColumn;
    cxGrid2DBTableView2F_END_OST: TcxGridDBColumn;
    cxGrid2DBTableView2F_GOOD_GRP: TcxGridDBColumn;
    cxGrid2DBTableView2F_GOOD_NAME: TcxGridDBColumn;
    cxGrid2DBTableView2F_GOOD_ARTICLE: TcxGridDBColumn;
    cxGrid2DBTableView2F_GOOD_GRP_NAME: TcxGridDBColumn;
    cxGrid2DBTableView2F_GOOD_GRP_COLOR: TcxGridDBColumn;
    cxGrid2DBTableView2F_PRICE_VAL: TcxGridDBColumn;
    cxGrid2DBTableView2F_GOOD_DOP_INFO: TcxGridDBColumn;
    cxGrid2DBTableView2F_PHOTO_EXISTS: TcxGridDBColumn;
...
begin
  ...
  dsGoodScancodes.ParamByName('P_DATE').Value := date;
  dsGoodScancodes.Active := true;
