...
// WSDL     : http://10.8.1.30:8080/WebApplicationTima/OutDocumentServicesImpl?wsdl
//  >Import : http://10.8.1.30:8080/WebApplicationTima/OutDocumentServicesImpl?wsdl>0
//  >Import : http://10.8.1.30:8080/WebApplicationTima/OutDocumentServicesImpl?xsd=1
// Encoding : UTF-8
// Version  : 1.0
// (22.04.2022 14:58:32 - - $Rev: 90173 $)
// ************************************************************************ //
...
type
  ...
  myDate               = class;                 { "http://services.tima.com/"[GblCplx] }
  ...
  { "http://services.tima.com/"[GblSmpl] }
  sState = (EMPTY, READY, SENDED, GETED, COMPLETE, ERROR, DELETED, ARCHIVED);
  ...
  private
    ...
    procedure Setf_docDate(Index: Integer; const AmyDate: myDate);
    function  f_docDate_Specified(Index: Integer): boolean;
  ...
  published
    ...
    property f_docDate:    myDate                Index (IS_OPTN or IS_UNQL) read Ff_docDate write Setf_docDate stored f_docDate_Specified;
  ...
  // ************************************************************************ //
  // XML       : myDate, global, <complexType>
  // Namespace : http://services.tima.com/
  // ************************************************************************ //
  myDate = class(TRemotable)
  private
    Ff_day: Integer;
    Ff_month: Integer;
    Ff_year: Integer;
  published
    property f_day:   Integer  Index (IS_UNQL) read Ff_day write Ff_day;
    property f_month: Integer  Index (IS_UNQL) read Ff_month write Ff_month;
    property f_year:  Integer  Index (IS_UNQL) read Ff_year write Ff_year;
  end;
  ...
  // URL       : http://10.8.1.30:8080/WebApplicationTima/OutDocumentServicesImpl
  // ************************************************************************ //
...
const
  defWSDL = 'http://10.8.1.30:8080/WebApplicationTima/OutDocumentServicesImpl?wsdl';
  defURL  = 'http://10.8.1.30:8080/WebApplicationTima/OutDocumentServicesImpl';
...
begin
  ...
  System.SysUtils.FreeAndNil(Ff_docDate);
...
procedure goodDocument.Setf_docDate(Index: Integer; const AmyDate: myDate);
begin
  Ff_docDate := AmyDate;
  Ff_docDate_Specified := True;
end;

function goodDocument.f_docDate_Specified(Index: Integer): boolean;
begin
  Result := Ff_docDate_Specified;
end;
...
initialization
  ...
  RemClassRegistry.RegisterXSClass(myDate, 'http://services.tima.com/', 'myDate');
