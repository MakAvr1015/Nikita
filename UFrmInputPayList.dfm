inherited FrmInputPayList: TFrmInputPayList
  ...
  object dsInputMoneyList: TpFIBDataSet
    DeleteSQL.Strings = (
    ...
    object dsInputMoneyListF_SKLAD_NAME: TStringField
      DisplayLabel = #1057#1082#1083#1072#1076
      FieldName = 'F_SKLAD_NAME'
      Size = 100
    end
    object dsInputMoneyListF_OWNER: TFIBBCDField
      FieldName = 'F_OWNER'
      Visible = False
      Size = 0
    end
    object dsInputMoneyListF_OWNER_NAME: TFIBStringField
