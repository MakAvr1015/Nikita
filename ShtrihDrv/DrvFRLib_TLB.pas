...
// PASTLWTR : 1.2
// File generated on 14.11.2013 11:28:50 from Type Library described below.

// ************************************************************************  //
// Type Lib: I:\Projects\DrvFRTrunk\Source\DrvFR\DrvFR.tlb (1)
// LIBID: {332C8050-469C-4B4D-A192-68CD3CB252BA}
// LCID: 0
// Helpfile: 
// HelpString: Äðàéâåð ÔÐ
// DepndLst: 
...
// *********************************************************************//
  IDrvFR1C = interface(IDispatch)
    ...
    function DeviceControlHEX(const DeviceID: WideString; const TxData: WideString; 
                              out RxData: WideString): WordBool; safecall;
    function Get_DiscountOnCheck: Integer; safecall;
    procedure Set_DiscountOnCheck(Value: Integer); safecall;
    property DiscountOnCheck: Integer read Get_DiscountOnCheck write Set_DiscountOnCheck;
  end;
...
// *********************************************************************//
  IDrvFR1CDisp = dispinterface
    ...
    property DiscountOnCheck: Integer dispid 221;
  end;
...
// *********************************************************************//
  ...
  published
    property Anchors;
    property DiscountOnCheck: Integer index 221 read GetIntegerProp write SetIntegerProp stored False;
  end;


// *********************************************************************//
// OLE Control Proxy class declaration
// Control Name     : TDrvFR3
// Help String      : Äðàéâåð ÔÐ 3
// Default Interface: IDrvFR11
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (2) CanCreate
// *********************************************************************//
  TDrvFR3 = class(TOleControl)
  private
    FIntf: IDrvFR11;
    function  GetControlInterface: IDrvFR11;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    ...
    function CloseCheckWithResult: Integer;
    function AboutBox: Integer;
    property  ControlInterface: IDrvFR11 read GetControlInterface;
    property  DefaultInterface: IDrvFR11 read GetControlInterface;
    property BatteryCondition: WordBool index 108 read GetWordBoolProp;
    property BatteryVoltage: Double index 109 read GetDoubleProp;
    property Change: Currency index 111 read GetCurrencyProp;
    property ContentsOfCashRegister: Currency index 115 read GetCurrencyProp;
...
procedure TDrvFR3.InitControlData;
const
  CControlData: TControlData2 = (
    ClassID: '{E0F9B0D6-E395-4DAD-B1E7-75B63FBE1FC7}';
    EventIID: '';
    EventCount: 0;
    EventDispIDs: nil;
    LicenseKey: nil (*HR:$00000000*);
...
procedure TDrvFR3.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IDrvFR11;
  end;
...
function TDrvFR3.GetControlInterface: IDrvFR11;
begin
  CreateControl;
  Result := FIntf;
end;

function TDrvFR3.AddLD: Integer;
begin
  Result := DefaultInterface.AddLD;
end;

function TDrvFR3.Beep: Integer;
begin
  Result := DefaultInterface.Beep;
end;

function TDrvFR3.Buy: Integer;
begin
  Result := DefaultInterface.Buy;
end;

function TDrvFR3.BuyEx: Integer;
begin
  Result := DefaultInterface.BuyEx;
end;

function TDrvFR3.CancelCheck: Integer;
begin
  Result := DefaultInterface.CancelCheck;
end;

function TDrvFR3.CashIncome: Integer;
begin
  Result := DefaultInterface.CashIncome;
end;

function TDrvFR3.CashOutcome: Integer;
begin
  Result := DefaultInterface.CashOutcome;
end;

function TDrvFR3.Charge: Integer;
begin
  Result := DefaultInterface.Charge;
end;

function TDrvFR3.CheckSubTotal: Integer;
begin
  Result := DefaultInterface.CheckSubTotal;
end;

function TDrvFR3.CloseCheck: Integer;
begin
  Result := DefaultInterface.CloseCheck;
end;

function TDrvFR3.ConfirmDate: Integer;
begin
  Result := DefaultInterface.ConfirmDate;
end;

function TDrvFR3.Connect: Integer;
begin
  Result := DefaultInterface.Connect;
end;

function TDrvFR3.ContinuePrint: Integer;
begin
  Result := DefaultInterface.ContinuePrint;
end;

function TDrvFR3.Correction: Integer;
begin
  Result := DefaultInterface.Correction;
end;

function TDrvFR3.CutCheck: Integer;
begin
  Result := DefaultInterface.CutCheck;
end;

function TDrvFR3.DampRequest: Integer;
begin
  Result := DefaultInterface.DampRequest;
end;

function TDrvFR3.DeleteLD: Integer;
begin
  Result := DefaultInterface.DeleteLD;
end;

function TDrvFR3.Disconnect: Integer;
begin
  Result := DefaultInterface.Disconnect;
end;

function TDrvFR3.Discount: Integer;
begin
  Result := DefaultInterface.Discount;
end;

function TDrvFR3.DozeOilCheck: Integer;
begin
  Result := DefaultInterface.DozeOilCheck;
end;

function TDrvFR3.Draw: Integer;
begin
  Result := DefaultInterface.Draw;
end;

function TDrvFR3.EKLZDepartmentReportInDatesRange: Integer;
begin
  Result := DefaultInterface.EKLZDepartmentReportInDatesRange;
end;

function TDrvFR3.EKLZDepartmentReportInSessionsRange: Integer;
begin
  Result := DefaultInterface.EKLZDepartmentReportInSessionsRange;
end;

function TDrvFR3.EKLZJournalOnSessionNumber: Integer;
begin
  Result := DefaultInterface.EKLZJournalOnSessionNumber;
end;

function TDrvFR3.EKLZSessionReportInDatesRange: Integer;
begin
  Result := DefaultInterface.EKLZSessionReportInDatesRange;
end;

function TDrvFR3.EKLZSessionReportInSessionsRange: Integer;
begin
  Result := DefaultInterface.EKLZSessionReportInSessionsRange;
end;

function TDrvFR3.ExchangeBytes: Integer;
begin
  Result := DefaultInterface.ExchangeBytes;
end;

function TDrvFR3.FeedDocument: Integer;
begin
  Result := DefaultInterface.FeedDocument;
end;

function TDrvFR3.Fiscalization: Integer;
begin
  Result := DefaultInterface.Fiscalization;
end;

function TDrvFR3.FiscalReportForDatesRange: Integer;
begin
  Result := DefaultInterface.FiscalReportForDatesRange;
end;

function TDrvFR3.FiscalReportForSessionRange: Integer;
begin
  Result := DefaultInterface.FiscalReportForSessionRange;
end;

function TDrvFR3.GetActiveLD: Integer;
begin
  Result := DefaultInterface.GetActiveLD;
end;

function TDrvFR3.EnumLD: Integer;
begin
  Result := DefaultInterface.EnumLD;
end;

function TDrvFR3.GetCashReg: Integer;
begin
  Result := DefaultInterface.GetCashReg;
end;

function TDrvFR3.GetCountLD: Integer;
begin
  Result := DefaultInterface.GetCountLD;
end;

function TDrvFR3.GetData: Integer;
begin
  Result := DefaultInterface.GetData;
end;

function TDrvFR3.GetDeviceMetrics: Integer;
begin
  Result := DefaultInterface.GetDeviceMetrics;
end;

function TDrvFR3.GetECRStatus: Integer;
begin
  Result := DefaultInterface.GetECRStatus;
end;

function TDrvFR3.GetShortECRStatus: Integer;
begin
  Result := DefaultInterface.GetShortECRStatus;
end;

function TDrvFR3.GetExchangeParam: Integer;
begin
  Result := DefaultInterface.GetExchangeParam;
end;

function TDrvFR3.GetFieldStruct: Integer;
begin
  Result := DefaultInterface.GetFieldStruct;
end;

function TDrvFR3.GetFiscalizationParameters: Integer;
begin
  Result := DefaultInterface.GetFiscalizationParameters;
end;

function TDrvFR3.GetFMRecordsSum: Integer;
begin
  Result := DefaultInterface.GetFMRecordsSum;
end;

function TDrvFR3.GetLastFMRecordDate: Integer;
begin
  Result := DefaultInterface.GetLastFMRecordDate;
end;

function TDrvFR3.GetLiterSumCounter: Integer;
begin
  Result := DefaultInterface.GetLiterSumCounter;
end;

function TDrvFR3.GetOperationReg: Integer;
begin
  Result := DefaultInterface.GetOperationReg;
end;

function TDrvFR3.GetParamLD: Integer;
begin
  Result := DefaultInterface.GetParamLD;
end;

function TDrvFR3.GetRangeDatesAndSessions: Integer;
begin
  Result := DefaultInterface.GetRangeDatesAndSessions;
end;

function TDrvFR3.GetRKStatus: Integer;
begin
  Result := DefaultInterface.GetRKStatus;
end;

function TDrvFR3.GetTableStruct: Integer;
begin
  Result := DefaultInterface.GetTableStruct;
end;

function TDrvFR3.InitFM: Integer;
begin
  Result := DefaultInterface.InitFM;
end;

function TDrvFR3.InitTable: Integer;
begin
  Result := DefaultInterface.InitTable;
end;

function TDrvFR3.InterruptDataStream: Integer;
begin
  Result := DefaultInterface.InterruptDataStream;
end;

function TDrvFR3.InterruptFullReport: Integer;
begin
  Result := DefaultInterface.InterruptFullReport;
end;

function TDrvFR3.InterruptTest: Integer;
begin
  Result := DefaultInterface.InterruptTest;
end;

function TDrvFR3.LaunchRK: Integer;
begin
  Result := DefaultInterface.LaunchRK;
end;

function TDrvFR3.LoadLineData: Integer;
begin
  Result := DefaultInterface.LoadLineData;
end;

function TDrvFR3.OilSale: Integer;
begin
  Result := DefaultInterface.OilSale;
end;

function TDrvFR3.OpenCheck: Integer;
begin
  Result := DefaultInterface.OpenCheck;
end;

function TDrvFR3.OpenDrawer: Integer;
begin
  Result := DefaultInterface.OpenDrawer;
end;

function TDrvFR3.PrintBarCode: Integer;
begin
  Result := DefaultInterface.PrintBarCode;
end;

function TDrvFR3.PrintDepartmentReport: Integer;
begin
  Result := DefaultInterface.PrintDepartmentReport;
end;

function TDrvFR3.PrintDocumentTitle: Integer;
begin
  Result := DefaultInterface.PrintDocumentTitle;
end;

function TDrvFR3.PrintOperationReg: Integer;
begin
  Result := DefaultInterface.PrintOperationReg;
end;

function TDrvFR3.PrintReportWithCleaning: Integer;
begin
  Result := DefaultInterface.PrintReportWithCleaning;
end;

function TDrvFR3.PrintReportWithoutCleaning: Integer;
begin
  Result := DefaultInterface.PrintReportWithoutCleaning;
end;

function TDrvFR3.PrintString: Integer;
begin
  Result := DefaultInterface.PrintString;
end;

function TDrvFR3.PrintWideString: Integer;
begin
  Result := DefaultInterface.PrintWideString;
end;

function TDrvFR3.ReadEKLZDocumentOnKPK: Integer;
begin
  Result := DefaultInterface.ReadEKLZDocumentOnKPK;
end;

function TDrvFR3.ReadEKLZSessionTotal: Integer;
begin
  Result := DefaultInterface.ReadEKLZSessionTotal;
end;

function TDrvFR3.ReadLicense: Integer;
begin
  Result := DefaultInterface.ReadLicense;
end;

function TDrvFR3.ReadTable: Integer;
begin
  Result := DefaultInterface.ReadTable;
end;

function TDrvFR3.RepeatDocument: Integer;
begin
  Result := DefaultInterface.RepeatDocument;
end;

function TDrvFR3.ResetAllTRK: Integer;
begin
  Result := DefaultInterface.ResetAllTRK;
end;

function TDrvFR3.ResetRK: Integer;
begin
  Result := DefaultInterface.ResetRK;
end;

function TDrvFR3.ResetSettings: Integer;
begin
  Result := DefaultInterface.ResetSettings;
end;

function TDrvFR3.ResetSummary: Integer;
begin
  Result := DefaultInterface.ResetSummary;
end;

function TDrvFR3.ReturnBuy: Integer;
begin
  Result := DefaultInterface.ReturnBuy;
end;

function TDrvFR3.ReturnBuyEx: Integer;
begin
  Result := DefaultInterface.ReturnBuyEx;
end;

function TDrvFR3.ReturnSale: Integer;
begin
  Result := DefaultInterface.ReturnSale;
end;

function TDrvFR3.ReturnSaleEx: Integer;
begin
  Result := DefaultInterface.ReturnSaleEx;
end;

function TDrvFR3.Sale: Integer;
begin
  Result := DefaultInterface.Sale;
end;

function TDrvFR3.SaleEx: Integer;
begin
  Result := DefaultInterface.SaleEx;
end;

function TDrvFR3.SetActiveLD: Integer;
begin
  Result := DefaultInterface.SetActiveLD;
end;

function TDrvFR3.SetDate: Integer;
begin
  Result := DefaultInterface.SetDate;
end;

function TDrvFR3.SetDozeInMilliliters: Integer;
begin
  Result := DefaultInterface.SetDozeInMilliliters;
end;

function TDrvFR3.SetDozeInMoney: Integer;
begin
  Result := DefaultInterface.SetDozeInMoney;
end;

function TDrvFR3.SetExchangeParam: Integer;
begin
  Result := DefaultInterface.SetExchangeParam;
end;

function TDrvFR3.SetParamLD: Integer;
begin
  Result := DefaultInterface.SetParamLD;
end;

function TDrvFR3.SetPointPosition: Integer;
begin
  Result := DefaultInterface.SetPointPosition;
end;

function TDrvFR3.SetRKParameters: Integer;
begin
  Result := DefaultInterface.SetRKParameters;
end;

function TDrvFR3.SetSerialNumber: Integer;
begin
  Result := DefaultInterface.SetSerialNumber;
end;

function TDrvFR3.SetTime: Integer;
begin
  Result := DefaultInterface.SetTime;
end;

function TDrvFR3.ShowProperties: Integer;
begin
  Result := DefaultInterface.ShowProperties;
end;

function TDrvFR3.StopEKLZDocumentPrinting: Integer;
begin
  Result := DefaultInterface.StopEKLZDocumentPrinting;
end;

function TDrvFR3.StopRK: Integer;
begin
  Result := DefaultInterface.StopRK;
end;

function TDrvFR3.Storno: Integer;
begin
  Result := DefaultInterface.Storno;
end;

function TDrvFR3.StornoEx: Integer;
begin
  Result := DefaultInterface.StornoEx;
end;

function TDrvFR3.StornoCharge: Integer;
begin
  Result := DefaultInterface.StornoCharge;
end;

function TDrvFR3.StornoDiscount: Integer;
begin
  Result := DefaultInterface.StornoDiscount;
end;

function TDrvFR3.SummOilCheck: Integer;
begin
  Result := DefaultInterface.SummOilCheck;
end;

function TDrvFR3.SysAdminCancelCheck: Integer;
begin
  Result := DefaultInterface.SysAdminCancelCheck;
end;

function TDrvFR3.Test: Integer;
begin
  Result := DefaultInterface.Test;
end;

function TDrvFR3.WriteLicense: Integer;
begin
  Result := DefaultInterface.WriteLicense;
end;

function TDrvFR3.WriteTable: Integer;
begin
  Result := DefaultInterface.WriteTable;
end;

function TDrvFR3.PrintStringWithFont: Integer;
begin
  Result := DefaultInterface.PrintStringWithFont;
end;

function TDrvFR3.EKLZActivizationResult: Integer;
begin
  Result := DefaultInterface.EKLZActivizationResult;
end;

function TDrvFR3.EKLZActivization: Integer;
begin
  Result := DefaultInterface.EKLZActivization;
end;

function TDrvFR3.CloseEKLZArchive: Integer;
begin
  Result := DefaultInterface.CloseEKLZArchive;
end;

function TDrvFR3.GetEKLZSerialNumber: Integer;
begin
  Result := DefaultInterface.GetEKLZSerialNumber;
end;

function TDrvFR3.EKLZInterrupt: Integer;
begin
  Result := DefaultInterface.EKLZInterrupt;
end;

function TDrvFR3.GetEKLZCode1Report: Integer;
begin
  Result := DefaultInterface.GetEKLZCode1Report;
end;

function TDrvFR3.GetEKLZCode2Report: Integer;
begin
  Result := DefaultInterface.GetEKLZCode2Report;
end;

function TDrvFR3.TestEKLZArchiveIntegrity: Integer;
begin
  Result := DefaultInterface.TestEKLZArchiveIntegrity;
end;

function TDrvFR3.GetEKLZVersion: Integer;
begin
  Result := DefaultInterface.GetEKLZVersion;
end;

function TDrvFR3.InitEKLZArchive: Integer;
begin
  Result := DefaultInterface.InitEKLZArchive;
end;

function TDrvFR3.GetEKLZData: Integer;
begin
  Result := DefaultInterface.GetEKLZData;
end;

function TDrvFR3.GetEKLZJournal: Integer;
begin
  Result := DefaultInterface.GetEKLZJournal;
end;

function TDrvFR3.GetEKLZDocument: Integer;
begin
  Result := DefaultInterface.GetEKLZDocument;
end;

function TDrvFR3.GetEKLZDepartmentReportInDatesRange: Integer;
begin
  Result := DefaultInterface.GetEKLZDepartmentReportInDatesRange;
end;

function TDrvFR3.GetEKLZDepartmentReportInSessionsRange: Integer;
begin
  Result := DefaultInterface.GetEKLZDepartmentReportInSessionsRange;
end;

function TDrvFR3.GetEKLZSessionReportInDatesRange: Integer;
begin
  Result := DefaultInterface.GetEKLZSessionReportInDatesRange;
end;

function TDrvFR3.GetEKLZSessionReportInSessionsRange: Integer;
begin
  Result := DefaultInterface.GetEKLZSessionReportInSessionsRange;
end;

function TDrvFR3.GetEKLZSessionTotal: Integer;
begin
  Result := DefaultInterface.GetEKLZSessionTotal;
end;

function TDrvFR3.GetEKLZActivizationResult: Integer;
begin
  Result := DefaultInterface.GetEKLZActivizationResult;
end;

function TDrvFR3.SetEKLZResultCode: Integer;
begin
  Result := DefaultInterface.SetEKLZResultCode;
end;

function TDrvFR3.OpenFiscalSlipDocument: Integer;
begin
  Result := DefaultInterface.OpenFiscalSlipDocument;
end;

function TDrvFR3.OpenStandardFiscalSlipDocument: Integer;
begin
  Result := DefaultInterface.OpenStandardFiscalSlipDocument;
end;

function TDrvFR3.RegistrationOnSlipDocument: Integer;
begin
  Result := DefaultInterface.RegistrationOnSlipDocument;
end;

function TDrvFR3.StandardRegistrationOnSlipDocument: Integer;
begin
  Result := DefaultInterface.StandardRegistrationOnSlipDocument;
end;

function TDrvFR3.ChargeOnSlipDocument: Integer;
begin
  Result := DefaultInterface.ChargeOnSlipDocument;
end;

function TDrvFR3.StandardChargeOnSlipDocument: Integer;
begin
  Result := DefaultInterface.StandardChargeOnSlipDocument;
end;

function TDrvFR3.CloseCheckOnSlipDocument: Integer;
begin
  Result := DefaultInterface.CloseCheckOnSlipDocument;
end;

function TDrvFR3.StandardCloseCheckOnSlipDocument: Integer;
begin
  Result := DefaultInterface.StandardCloseCheckOnSlipDocument;
end;

function TDrvFR3.ConfigureSlipDocument: Integer;
begin
  Result := DefaultInterface.ConfigureSlipDocument;
end;

function TDrvFR3.ConfigureStandardSlipDocument: Integer;
begin
  Result := DefaultInterface.ConfigureStandardSlipDocument;
end;

function TDrvFR3.FillSlipDocumentWithUnfiscalInfo: Integer;
begin
  Result := DefaultInterface.FillSlipDocumentWithUnfiscalInfo;
end;

function TDrvFR3.ClearSlipDocumentBufferString: Integer;
begin
  Result := DefaultInterface.ClearSlipDocumentBufferString;
end;

function TDrvFR3.ClearSlipDocumentBuffer: Integer;
begin
  Result := DefaultInterface.ClearSlipDocumentBuffer;
end;

function TDrvFR3.PrintSlipDocument: Integer;
begin
  Result := DefaultInterface.PrintSlipDocument;
end;

function TDrvFR3.DiscountOnSlipDocument: Integer;
begin
  Result := DefaultInterface.DiscountOnSlipDocument;
end;

function TDrvFR3.StandardDiscountOnSlipDocument: Integer;
begin
  Result := DefaultInterface.StandardDiscountOnSlipDocument;
end;

function TDrvFR3.EjectSlipDocument: Integer;
begin
  Result := DefaultInterface.EjectSlipDocument;
end;

function TDrvFR3.LoadLineDataEx: Integer;
begin
  Result := DefaultInterface.LoadLineDataEx;
end;

function TDrvFR3.DrawEx: Integer;
begin
  Result := DefaultInterface.DrawEx;
end;

function TDrvFR3.ConfigureGeneralSlipDocument: Integer;
begin
  Result := DefaultInterface.ConfigureGeneralSlipDocument;
end;

function TDrvFR3.WideLoadLineData: Integer;
begin
  Result := DefaultInterface.WideLoadLineData;
end;

function TDrvFR3.PrintTaxReport: Integer;
begin
  Result := DefaultInterface.PrintTaxReport;
end;

function TDrvFR3.GetLongSerialNumberAndLongRNM: Integer;
begin
  Result := DefaultInterface.GetLongSerialNumberAndLongRNM;
end;

function TDrvFR3.SetLongSerialNumber: Integer;
begin
  Result := DefaultInterface.SetLongSerialNumber;
end;

function TDrvFR3.FiscalizationWithLongRNM: Integer;
begin
  Result := DefaultInterface.FiscalizationWithLongRNM;
end;

function TDrvFR3.Connect2: Integer;
begin
  Result := DefaultInterface.Connect2;
end;

function TDrvFR3.GetECRPrinterStatus: Integer;
begin
  Result := DefaultInterface.GetECRPrinterStatus;
end;

function TDrvFR3.ServerConnect: Integer;
begin
  Result := DefaultInterface.ServerConnect;
end;

function TDrvFR3.ServerDisconnect: Integer;
begin
  Result := DefaultInterface.ServerDisconnect;
end;

function TDrvFR3.LockPort: Integer;
begin
  Result := DefaultInterface.LockPort;
end;

function TDrvFR3.UnlockPort: Integer;
begin
  Result := DefaultInterface.UnlockPort;
end;

function TDrvFR3.AdminUnlockPort: Integer;
begin
  Result := DefaultInterface.AdminUnlockPort;
end;

function TDrvFR3.AdminUnlockPorts: Integer;
begin
  Result := DefaultInterface.AdminUnlockPorts;
end;

function TDrvFR3.ServerCheckKey: Integer;
begin
  Result := DefaultInterface.ServerCheckKey;
end;

function TDrvFR3.GetFontMetrics: Integer;
begin
  Result := DefaultInterface.GetFontMetrics;
end;

function TDrvFR3.GetFreeLDNumber: Integer;
begin
  Result := DefaultInterface.GetFreeLDNumber;
end;

procedure TDrvFR3.SetIsString(Value: WordBool);
begin
  DefaultInterface.SetIsString(Value);
end;

procedure TDrvFR3.SetFieldSize(Value: Integer);
begin
  DefaultInterface.SetFieldSize(Value);
end;

function TDrvFR3.ReadTable2: Integer;
begin
  Result := DefaultInterface.ReadTable2;
end;

function TDrvFR3.WriteTable2: Integer;
begin
  Result := DefaultInterface.WriteTable2;
end;

procedure TDrvFR3.SetFieldMinValue(Value: Integer);
begin
  DefaultInterface.SetFieldMinValue(Value);
end;

procedure TDrvFR3.SetFieldMaxValue(Value: Integer);
begin
  DefaultInterface.SetFieldMaxValue(Value);
end;

function TDrvFR3.CashControlOpen: Integer;
begin
  Result := DefaultInterface.CashControlOpen;
end;

function TDrvFR3.CashControlClose: Integer;
begin
  Result := DefaultInterface.CashControlClose;
end;

function TDrvFR3.SaveParams: Integer;
begin
  Result := DefaultInterface.SaveParams;
end;

function TDrvFR3.GetEKLZCode1Status: Integer;
begin
  Result := DefaultInterface.GetEKLZCode1Status;
end;

function TDrvFR3.GetEKLZCode2Status: Integer;
begin
  Result := DefaultInterface.GetEKLZCode2Status;
end;

function TDrvFR3.ReadWriteFM: Integer;
begin
  Result := DefaultInterface.ReadWriteFM;
end;

function TDrvFR3.PrintHeader: Integer;
begin
  Result := DefaultInterface.PrintHeader;
end;

function TDrvFR3.CloseCheckWithResult: Integer;
begin
  Result := DefaultInterface.CloseCheckWithResult;
end;

function TDrvFR3.AboutBox: Integer;
begin
  Result := DefaultInterface.AboutBox;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TDrvFR, TDrvFR1C, TDrvFR3, TDrvFR1C11]);
end;
